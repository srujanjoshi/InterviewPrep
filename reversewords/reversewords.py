...
def reverse_words(message):
    #Reverse the entire message in place, thus get the words in the correct positions
    start=0
    end=len(message)-1
    while (start<end):
    ...
    # Decode the message by reversing the individual words
    i=0
    start=0
    end=0
    while(i< len(message)):
